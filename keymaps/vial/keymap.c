...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, LT(1, KC_ENTER), LT(2, KC_SPACE), KC_MINUS, KC_PLUS
    ),
    [1] = LAYOUT(
        ...
        KC_LGUI, KC_LSFT, KC_TRNS, KC_LSFT, KC_TRNS, KC_TRNS
    ),
    [2] = LAYOUT(
        KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0,
        KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU, SGUI(KC_S), KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, 
